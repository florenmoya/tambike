...
describe("account and event-location UI contracts", () => {
  ...
  test("uses organizer-defined location inputs and location-card styling", () => {
    ...
    expect(screenSource).toContain("event-detail-location-card");
    expect(stylesSource).toContain(".event-detail-location-card");
