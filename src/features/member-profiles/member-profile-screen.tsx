        ...
        <article className="garage-card" aria-labelledby="garage-card-title">
          ...
          {motorcycle ? (
            <section className="garage-showcase" aria-labelledby="motorcycle-title">
              ...
              {hero ? (
                <div className="garage-motorcycle-hero">
                  <MemberMediaImage
                    ...
                    priority
                  />
                  <span className="garage-photo-index">01 / {String(photos.length).padStart(2, "0")}</span>
                </div>
              ) : (
              ...
              {motorcycle.description ? <p className="garage-motorcycle-story">{motorcycle.description}</p> : null}
