...
export function createAccountAccessActions(dependencies: AccountActionDependencies) {
  ...
  async function mutateAccount(
    ...
    try {
      ...
      return actionError(error, accountErrorMessages) as ActionState<AdminUserAccount>;
    }
  }
